...
mod test {
    ...
    fn make_virtual_machine_and_logger(instructions: Arc<[Instruction]>) -> (VirtualMachine, Logger) {
        ...
        (VirtualMachine::new(logger_sender, sender, receiver, instructions.clone()), Logger::new(logger_receiver))
    }
    ...
    fn fibo() {
        let instructions = Arc::new([
            ...
            Instruction::Call { function_name: Functions::VectorInitInteger, output: 6, arguments: Vec::new() },
            ...
            Instruction::Call { function_name: Functions::VectorPushInteger, output: 9, arguments: vec![6, 7] },
            Instruction::Call { function_name: Functions::VectorPushInteger, output: 10, arguments: vec![9, 8] },
        ]);
    }
}